...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name_or_path", default="./model", type=str, help="Model name or path")
    ...
    parser.add_argument("--sQuare", action="store_true", help="For sQuare")
    #parser.add_argument("--element_type", type=int, default=0, help="0: post, 1: comment from sQuare") # 게시글이 영어로 post가 맞던가? ㅋㅅㅋ
